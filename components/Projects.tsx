...
const projectsData: Project[] = [
    {
        id: 1,
        title: 'UPCODE',
        description: 'A comprehensive coding and interview platform designed to help developers practice coding problems and prepare for technical interviews.',
        tags: ['React', 'Node.js', 'MongoDB', 'Interview Prep'],
        liveUrl: 'https://upcode-coding-and-interview-platfor.vercel.app/',
        codeUrl: 'https://github.com/RajdeepKushwaha5/UPCODE',
    },
    {
        id: 2,
        title: 'RAG-Visualizer',
        description: 'An interactive visualization tool for Retrieval-Augmented Generation (RAG) systems, helping users understand how RAG models work.',
        tags: ['React', 'AI', 'Visualization', 'RAG'],
        liveUrl: 'https://rag-visualizer.vercel.app/',
        codeUrl: 'https://github.com/RajdeepKushwaha5/rag-visualizer',
    },
    {
        id: 3,
        title: 'EV-Adoption-Forecasting',
        description: 'A machine learning application that forecasts electric vehicle adoption rates using predictive analytics and data visualization.',
        tags: ['Python', 'Streamlit', 'Machine Learning', 'Data Science'],
        liveUrl: 'https://ev-adoption-forecasting-ouj8effthzovtxnlwvnase.streamlit.app/',
        codeUrl: 'https://github.com/RajdeepKushwaha5/EV-Adoption-Forecasting',
    },
    {
        id: 4,
        title: 'Code-Reviewer',
        description: 'An AI-powered code review tool that analyzes code quality, suggests improvements, and provides detailed feedback for better programming practices.',
        tags: ['React', 'AI', 'Code Analysis', 'Developer Tools'],
        liveUrl: 'https://code-reviewer-mocha.vercel.app/',
        codeUrl: 'https://github.com/RajdeepKushwaha5/Code-Reviewer',
    },
    {
        id: 5,
